...
class AppDimensions {
  ...
  static double h10 = screenHeight / 75;
  static double h20 = screenHeight / 37.5;
  static double h100 = screenHeight / 7.5;
  static double h200 = screenHeight / 3.75;
  static double h50 = screenHeight / 15;
  static double h15 = screenHeight / 50;
  static double h5 = screenHeight / 150;
}
